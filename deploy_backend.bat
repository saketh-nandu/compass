@echo off
REM ============================================================================
REM COMPASS APP - BACKEND DEPLOYMENT SCRIPT (Windows)
REM ============================================================================
REM This script deploys the entire backend to Supabase
REM Usage: deploy_backend.bat
REM ============================================================================
...
call supabase link --project-ref oltzkkchoohpwbipqkeh

echo.
echo ✅ Project linked successfully
echo.

REM Step 2: Deploy migrations
...
REM Step 3: Instructions for creating users
